...
generateEmailFormGroup(): FormGroup {
  return this.fb.group({
    ...
    emailValue: ["", [Validators.required, Validators.pattern("^[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,4}$")]],
  });
}
...
add(p: Patient,  phone1:Phone,phone2:Phone,phone3:Phone,address1:Address,address2:Address,address3:Address,email1:Email,email2:Email,email3:Email) {

 console.log(p,phone1,phone2,phone3, address1,address2,address3,email1,email2,email3);
    ...
    this.snackBar.open(message, '', {
      ...
      onImageSelected(event: any): void {
        ...
        if (fileInput.files && fileInput.files[0]) {
          ...
          this.imageLabel = this.selectedImageFile.name;
    
          reader.onload = (e: any) => {
            this.selectedImageURL = `url('${e.target.result}')`;
            this.selectedImageURLToSave = e.target.result;
          };
